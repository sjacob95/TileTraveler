...
public class Map
{
     ...
     *
     * @param mapDim
     *            - the desired dimensions of the Map
     */
     ...
     *
     * @param strings
     *            - a series of Strings to be converted to a Map
     */
        ...
        for (int y = strings.length - 1; y >= 0; y--)
        {
            for (int x = 0; x < strings[y].length(); x++)
            {
                setTile(
                    x,
                    strings.length - (y + 1),
                    convertToTile(strings[y].charAt(x)));
            }
        }
     ...
     *
     * @param x
     *            - the the x coordinate of the Location to be set
     * @param y
     *            - the the y coordinate of the Location to be set
     * @param tile
     *            - the desired Tile
     */
     ...
     *            - the the y coordinate of the Location to be set
     * @param symbol
     *            - the the character representation of the desired Tile
     */
     ...
     * @return the Tile at a given Location
     * @param loc
     *            - the Location of the Tile to be returned
     */
...
// the first row's length
    ...
    /**
     * Prints the map out to a string.
     *
